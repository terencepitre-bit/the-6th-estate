...
_BRIEFING_SYSTEM = (
    ...
    "sources. Write 60-75 words, factual and non-editorial. Prefer 'could' over "
    "'should' when consequences are uncertain. Return strict JSON."
)
_QUICK_HIT_SYSTEM = (
...
class GeminiWriter:
    ...
    def _call(self, model: str, system: str, prompt: str) -> dict:
        ...
        resp = get_json(url, headers={"Content-Type": "application/json"})  # transport used in tests
        return resp

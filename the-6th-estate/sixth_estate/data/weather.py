...
# Default gridpoint: Washington, DC area. Override with a resolved forecast URL.
DEFAULT_FORECAST_URL = f"{config.WEATHER_API_BASE}/gridpoints/LWX/96,70/forecast"
